...
const Footer = () => {
 ...
 <div className="flex flex-col -mt-16">
  {/* Logo */}
  <img src={logo} alt="KachuKart Logo" className="h-50 w-50" /> {/* add bottom margin for spacing */}
  ...
  <a href="#" className="w-10 h-10 flex items-center justify-center rounded-full bg-gray-700 hover:bg-black transition-colors">
    <FaXTwitter  className="text-white w-5 h-5" />
        ...
        <div className="flex flex-col gap-2 items-start md:items-center">
          ...
          <button className="bg-green-500 hover:bg-green-600 text-white font-semibold py-2 px-4 rounded flex items-center gap-2 transition-colors cursor-pointer">
        ...
        <div className="flex flex-col gap-2 items-start md:items-end ">
          ...
          <div className="flex text-center gap-4 text-sm"><FaPhone className="text-white text-[18px]" /> <span className="mr-8">9876549087</span></div>
          <div className="flex text-center gap-4 text-sm"><FaEnvelope className="text-white text-[18px]" /> <span>logo@gmail.com</span></div>
          <div className="flex text-center gap-4 text-sm"><FaWhatsapp className="text-white  text-[18px]" /> <span className="mr-7">9087462091</span></div>
        </div>
